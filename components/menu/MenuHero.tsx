...
import { ChevronDown, Coffee, Soup, Utensils } from "lucide-react";

const HEADLINE = "Rasa Nusantara, Disajikan Modern";

const QUICK_STATS = [
  { icon: Utensils, label: "7 Kategori", detail: "Makanan & minuman" },
  { icon: Soup, label: "Mulai 23 ribu", detail: "Menu ala carte" },
  { icon: Coffee, label: "Paket Grup", detail: "Buffet & meal box" },
];
...
export function MenuHero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex h-[82vh] min-h-[560px] items-center justify-center overflow-hidden bg-wood-900"
    >
      <motion.div
      ...
      >
        <Image
          ...
          alt="Sajian khas WJS Joko Sambang Café tertata di atas meja"
          fill
          priority
          sizes="100vw"
      ...
      >
        ...
        >
          Dari nasi goreng rawon sampai jamu gula asem. Bumbu tradisionalnya
          tetap dijaga, cara menyajikannya yang kami perbarui.
        </motion.p>
