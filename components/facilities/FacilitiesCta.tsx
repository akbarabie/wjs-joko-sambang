...
export function FacilitiesCta() {
  return (
    <section className="px-6 pb-24 pt-4 sm:pb-28">
      ...
      >
        {/* Aksen lingkaran samar sebagai pengganti foto, supaya blok CTA tetap
            punya kedalaman visual tanpa menambah beban gambar baru. */}
        <div
        ...
        <h2 className="font-heading mx-auto mt-6 max-w-2xl text-3xl font-semibold text-cream-100 sm:text-4xl">
          Sudah Tahu Mau Duduk di Mana?
        </h2>
        <p className="mx-auto mt-5 max-w-xl text-cream-200/80">
          Kabari kami dulu untuk acara berkelompok atau pemakaian ruang VIP,
          supaya tempatnya bisa kami siapkan sesuai kebutuhanmu.
        </p>
